...
Nova, built on the Hedera  Blockchain, offers the following functionalities:
...
3. 🔗 **Immutable Reviews**: All user reviews are stored on-chain using Hedera ’s secure blockchain, ensuring they cannot be altered.
...
6. 💰 **Decentralized and Secure Payments**: Transactions (such as bookings and payments) are handled using Hedera ’s blockchain, ensuring fast processing times and low fees.

## 🛠️ How We Built It

1. 🔗 **Hedera  Blockchain**: Chosen for its fast 5-second block finality, low transaction costs, and high throughput, making it perfect for real-time interactions.
...
7. 🖥️ **Backend (Node.js)**:
   - Handles user authentication, API requests, and interactions with Hedera ’s smart contracts.
...
2. ⚡ **Seamless Integration with Hedera **: Fully integrated Hedera ’s fast and low-cost transactions for booking payments and review submissions.
...
1. 🔗 **Blockchain Development with Hedera **: Understanding IBFT consensus protocol and leveraging high throughput and low transaction costs.
...
- 🔗 **Blockchain**: Hedera  (IBFT Consensus)
